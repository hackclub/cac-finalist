# Parent's Guide & FAQ to The Congressional Hackathon:
...
## What is The Congressional Hackathon?

The Congressional Hackathon is a&#x20;
...
*These times (not dates) could change, but they will be thoroughly communicated if so.*
