...
const Footer = () => {
  return (
    <footer className='font-[family-name:var(--font-geist-mono)]'>
        <div className="footer-wrapper">
            <div className="footer-information">
                <p className="footer-information-header">
            ...
            <article className="footer-links">
                ...
                <div className="footer-links-column">
                    ...
                    <span>
                        <a href="tel:1-855-625-HACK" className="footer-tel">1-855-625-HACK</a>
                        <span>(call toll-free)</span>
                    </span>
                </div>
            </article>
            <p className="footer-cr-info">© 2024 Hack&nbsp;Club. 501(c)(3) nonprofit (EIN: 81-2908499)</p>
        </div>
    </footer>
  )
}
