        ...
        <nav className="relative bg-[var(--cac-blue)] shadow-md px-4 py-5 font-[family-name:var(--font-geist-mono)]">
            <div className="max-w-7xl mx-auto flex items-center justify-between relative">
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 text-white text-xl font-semibold">
                    Hack Club Congressional App Challenge Finalist Award
                </div>
            ...
            {isOpen && (
                <ul className="md:hidden mt-2 space-y-2 px-2 pb-3 text-white font-medium">
                    <li><a href="#" className="block px-2 py-1 rounded hover:bg-blue-600">Home</a></li>
                    <li><a href="#" className="block px-2 py-1 rounded hover:bg-blue-600">About</a></li>
                    <li><a href="#" className="block px-2 py-1 rounded hover:bg-blue-600">Services</a></li>
                    <li><a href="#" className="block px-2 py-1 rounded hover:bg-blue-600">Contact</a></li>
                </ul>
            )}
        </nav>
